...
void AClueMultiCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AClueMultiCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AClueMultiCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AClueMultiCharacter::Look);

	}

}

void AClueMultiCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AClueMultiCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AClueMultiCharacter::CreateGameSession()
{
